...
const SetProfile = () => {
  return (  
   ...
   <div>
   <div>
   <input type="text" className="inputs my-2" placeholder='SKILLS'/>
</div>
<br />


<input
  type="text" className="inputs my-2" placeholder='EXPERIENCE'
...
<br />
<input
  type="text" className="inputs my-2" placeholder='EDUCATION'
